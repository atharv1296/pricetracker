...
function Phone() {
  ...
  const prices = ["12,999", "13,999", "17,999", "39,999", "31,147", "1,48,900", "42,999", "1,39,999", "43,999", "24,649", "25,745", "63,999", "32,987", "72,200", "52,999"];
    ...
    <>
      <div className="flex flex-wrap justify-center m-0 p-0">
        {titles.map((title, index) => (
          <div key={index} className={`max-w-sm rounded overflow-hidden justify-center shadow-lg m-4 cursor-pointer ${index < 3 ? 'mt-24' : ''}`} onClick={() => handleDivClick(title, prices[index], images[index])}>
            <div className="img h-90  ml-5 w-60 flex justify-center items-center"> {/* Set fixed height and width */}
